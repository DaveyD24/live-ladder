function render(game) {
    return `
        <div class="live-game w-9/10 max-w-200 flex flex-col items-center justify-center rounded-lg border border-slate-200 dark:border-neutral-700 shadow-lg dark:shadow-md dark:shadow-white/10 transition-all duration-200 ease-in-out">
