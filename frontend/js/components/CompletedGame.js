function render(game) {
    return `
        <div class="w-9/10 max-w-200 flex flex-col items-center justify-center rounded-lg border border-slate-200 dark:border-neutral-700 opacity-70 transition-all duration-200 ease-in-out">
            ...
            <div class="flex items-center justify-between px-3 md:px-6 py-4 w-full bg-white dark:bg-neutral-950">
                ...
                <div class="flex items-center gap-2 font-inter">
                    <span class="text-2xl md:text-4xl font-bold dark:text-zinc-50">${game.homeTeam.score}</span>
                    <span class="text-xl md:text-2xl text-slate-300 dark:text-neutral-400">-</span>
                    <span class="text-2xl md:text-4xl font-bold dark:text-zinc-50">${game.awayTeam.score}</span>
                </div>
                <div class="flex items-center">
