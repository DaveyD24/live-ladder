...
function render(team) {
    return `
        <div class="relative flex flex-row justify-between items-center h-12 desktop:h-16 ${team.isPlaying ? colourPairs["playing"] : colourPairs["normal"]} border border-slate-200 dark:border-neutral-600 rounded-bl-lg rounded-tl-lg rounded-tr-lg rounded-br-lg">
            <div class="flex flex-row h-full justify-start items-center min-w-52 md:min-w-80 lg:min-w-96 desktop:min-w-85">
                <span class="${team.isPlaying ? 'live-patch' : ''} h-12 desktop:h-16 min-w-2.5 rounded-l-sm inline-block ${colourPairs[team.localName]}"></span>
            ...
            <span class="${team.isPlaying ? colourPairs["playing"] : colourPairs["normal"]} ml-8 h-12 desktop:h-16 inline-block w-[calc(100%-900px)] border-t border-b border-slate-200 dark:border-neutral-600"></span>
