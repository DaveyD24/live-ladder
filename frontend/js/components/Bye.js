function render(byes) {
    ...
    return `
        <div class="w-9/10 lg:w-95/100 desktop:w-9/10 max-w-200 lg:max-w-full desktop:max-w-200 relative bg-white dark:bg-neutral-950 flex flex-col gap-4 md:flex-row justify-center items-center py-4 rounded-lg border border-slate-200 dark:border-neutral-700 col-span-2
            ">
